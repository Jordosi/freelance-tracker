...
public class TaskController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TaskResponse> updateTask(@PathVariable Long id, @Valid @RequestBody TaskUpdateDto dto,
                                              @RequestParam Long projectId) {
    ...
    @GetMapping
    public ResponseEntity<Page<TaskResponse>> getByProjectId(@RequestParam Long projectId,
    ...
    public ResponseEntity<TaskResponse> reassignTask(@PathVariable Long id, @RequestParam Long projectId) {
    ...
    public ResponseEntity<TaskResponse> addTimeEntry(
